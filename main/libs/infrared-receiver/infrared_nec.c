...
bool nec_header_if(rmt_item32_t *item)
{
    ...
    if ((item->level0 == RMT_RX_ACTIVE_LEVEL &&
        ...
        nec_check_in_range(item->duration0, NEC_HEADER_HIGH_US,
                           NEC_BIT_MARGIN) &&
        nec_check_in_range(item->duration1, NEC_HEADER_LOW_US,
                           NEC_BIT_MARGIN)) {
        return true;
    }
    return false;
...
bool nec_bit_one_if(rmt_item32_t *item)
{
    ...
    if ((item->level0 == RMT_RX_ACTIVE_LEVEL &&
        ...
        nec_check_in_range(item->duration0, NEC_BIT_ONE_HIGH_US,
                           NEC_BIT_MARGIN) &&
        nec_check_in_range(item->duration1, NEC_BIT_ONE_LOW_US,
                           NEC_BIT_MARGIN)) {
        return true;
    }
    return false;
